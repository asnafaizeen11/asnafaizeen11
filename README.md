...
- Built full ML pipeline from preprocessing to model evaluation  
A Machine Learning Approach to Scholastic Performance Classification
- Multi-algorithm system to classify student performance  
- Compared Decision Tree, Random Forest, SVM, Gradient Boosting  
- Achieved highest accuracy of **89.69% with Decision Tree**  
Student Performance Predictor
- Full-stack web application predicting student performance  
- Uses inputs like study hours, sleep patterns, and attendance  
- Integrated prediction logic with responsive frontend  
...
GitHub: https://github.com/asnafaizeen11  
